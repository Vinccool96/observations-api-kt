...
class ReadOnlyIntWrapperTest {

    private lateinit var property: ReadOnlyIntWrapperMock

    private lateinit var readOnlyProperty: ReadOnlyIntProperty
    ...
    @Before
    fun setUp() {
        this.property = ReadOnlyIntWrapperMock()
    ...
    fun testConstructor_InitialValue() {
        val p = ReadOnlyIntWrapper(VALUE_1)
    ...
    fun testConstructor_Bean_Name_InitialValue() {
        val bean = Any()
        val name = "My name"
        val p = ReadOnlyIntWrapper(bean, name, VALUE_1)
        assertEquals(VALUE_1, p.get())
        assertEquals(VALUE_1, p.value)
        assertFalse(p.bound)
    ...
    fun testRebind() {
        ...
        val v2: IntProperty = SimpleIntProperty(VALUE_2)
    ...
    fun testToString() {
        ...
        this.property.set(VALUE_1)
        Assert.assertEquals("IntProperty [value: $VALUE_1]", this.property.toString())
        assertEquals("ReadOnlyIntProperty [value: $VALUE_1]", this.readOnlyProperty.toString())

        this.property.bind(v1)
        Assert.assertEquals("IntProperty [bound, invalid]", this.property.toString())
        assertEquals("ReadOnlyIntProperty [value: $VALUE_1]", this.readOnlyProperty.toString())
        this.property.get()
        Assert.assertEquals("IntProperty [bound, value: $VALUE_1]", this.property.toString())
        assertEquals("ReadOnlyIntProperty [value: $VALUE_1]", this.readOnlyProperty.toString())
        v1.set(VALUE_2)
        Assert.assertEquals("IntProperty [bound, invalid]", this.property.toString())
        assertEquals("ReadOnlyIntProperty [value: $VALUE_2]", this.readOnlyProperty.toString())
        this.property.get()
        Assert.assertEquals("IntProperty [bound, value: $VALUE_2]", this.property.toString())
        assertEquals("ReadOnlyIntProperty [value: $VALUE_2]", this.readOnlyProperty.toString())

        val bean = Any()
        val name = "My name"
        val v2 = ReadOnlyIntWrapper(bean, name, DEFAULT)
        assertEquals("IntProperty [bean: $bean, name: My name, value: $DEFAULT]", v2.toString())
        assertEquals("ReadOnlyIntProperty [bean: $bean, name: My name, value: $DEFAULT]",
                v2.readOnlyProperty.toString())

        val v3 = ReadOnlyIntWrapper(bean, "", DEFAULT)
        assertEquals("IntProperty [bean: $bean, value: $DEFAULT]", v3.toString())
        assertEquals("ReadOnlyIntProperty [bean: $bean, value: $DEFAULT]", v3.readOnlyProperty.toString())

        val v4 = ReadOnlyIntWrapper(null, name, DEFAULT)
        assertEquals("IntProperty [name: My name, value: $DEFAULT]", v4.toString())
        assertEquals("ReadOnlyIntProperty [name: My name, value: $DEFAULT]", v4.readOnlyProperty.toString())
    }

    private class ReadOnlyIntWrapperMock : ReadOnlyIntWrapper() {
    ...
    companion object {
        ...
        private val UNDEFINED: Int? = null

        private const val DEFAULT: Int = 0

        private const val VALUE_1: Int = -4354

        private const val VALUE_2: Int = 5

...
class ReadOnlyFloatWrapperTest {

    private lateinit var property: ReadOnlyFloatWrapperMock

    private lateinit var readOnlyProperty: ReadOnlyFloatProperty
    ...
    @Before
    fun setUp() {
        this.property = ReadOnlyFloatWrapperMock()
    ...
    fun testConstructor_InitialValue() {
        val p = ReadOnlyFloatWrapper(VALUE_1)
        assertEquals(VALUE_1, p.get())
        assertEquals(VALUE_1, p.value)
        assertFalse(p.bound)
        assertEquals(null, p.bean)
        assertEquals("", p.name)
        val r: ReadOnlyFloatProperty = p.readOnlyProperty
    ...
    fun testConstructor_Bean_Name() {
        val bean = Any()
        val name = "My name"
        val p = ReadOnlyFloatWrapper(bean, name)
    ...
    fun testConstructor_Bean_Name_InitialValue() {
        val bean = Any()
        val name = "My name"
        val p = ReadOnlyFloatWrapper(bean, name, VALUE_1)
        assertEquals(VALUE_1, p.get())
        assertEquals(VALUE_1, p.value)
        assertFalse(p.bound)
        assertEquals(bean, p.bean)
    ...
    fun testRebind() {
        attachInvalidationListeners()
        val v1: FloatProperty = SimpleFloatProperty(VALUE_1)
        val v2: FloatProperty = SimpleFloatProperty(VALUE_2)
    ...
    fun testToString() {
        ...
        this.property.set(VALUE_1)
        Assert.assertEquals("FloatProperty [value: $VALUE_1]", this.property.toString())
        assertEquals("ReadOnlyFloatProperty [value: $VALUE_1]", this.readOnlyProperty.toString())

        this.property.bind(v1)
        Assert.assertEquals("FloatProperty [bound, invalid]", this.property.toString())
        assertEquals("ReadOnlyFloatProperty [value: $VALUE_1]", this.readOnlyProperty.toString())
        this.property.get()
        Assert.assertEquals("FloatProperty [bound, value: $VALUE_1]", this.property.toString())
        assertEquals("ReadOnlyFloatProperty [value: $VALUE_1]", this.readOnlyProperty.toString())
        v1.set(VALUE_2)
        Assert.assertEquals("FloatProperty [bound, invalid]", this.property.toString())
        assertEquals("ReadOnlyFloatProperty [value: $VALUE_2]", this.readOnlyProperty.toString())
        this.property.get()
        Assert.assertEquals("FloatProperty [bound, value: $VALUE_2]", this.property.toString())
        assertEquals("ReadOnlyFloatProperty [value: $VALUE_2]", this.readOnlyProperty.toString())

        val bean = Any()
        val name = "My name"
        val v2 = ReadOnlyFloatWrapper(bean, name, DEFAULT)
        assertEquals("FloatProperty [bean: $bean, name: My name, value: $DEFAULT]", v2.toString())
        assertEquals("ReadOnlyFloatProperty [bean: $bean, name: My name, value: $DEFAULT]",
                v2.readOnlyProperty.toString())

        val v3 = ReadOnlyFloatWrapper(bean, "", DEFAULT)
        assertEquals("FloatProperty [bean: $bean, value: $DEFAULT]", v3.toString())
        assertEquals("ReadOnlyFloatProperty [bean: $bean, value: $DEFAULT]", v3.readOnlyProperty.toString())

        val v4 = ReadOnlyFloatWrapper(null, name, DEFAULT)
        assertEquals("FloatProperty [name: My name, value: $DEFAULT]", v4.toString())
        assertEquals("ReadOnlyFloatProperty [name: My name, value: $DEFAULT]", v4.readOnlyProperty.toString())
    }

    private class ReadOnlyFloatWrapperMock : ReadOnlyFloatWrapper() {

...
class ReadOnlyLongWrapperTest {

    private lateinit var property: ReadOnlyLongWrapperMock

    private lateinit var readOnlyProperty: ReadOnlyLongProperty
    ...
    @Before
    fun setUp() {
        this.property = ReadOnlyLongWrapperMock()
    ...
    fun testConstructor_InitialValue() {
        val p = ReadOnlyLongWrapper(VALUE_1)
        assertEquals(VALUE_1, p.get())
        assertEquals(VALUE_1, p.value)
        assertFalse(p.bound)
        assertEquals(null, p.bean)
        assertEquals("", p.name)
        val r: ReadOnlyLongProperty = p.readOnlyProperty
    ...
    fun testConstructor_Bean_Name() {
        val bean = Any()
        val name = "My name"
        val p = ReadOnlyLongWrapper(bean, name)
    ...
    fun testConstructor_Bean_Name_InitialValue() {
        val bean = Any()
        val name = "My name"
        val p = ReadOnlyLongWrapper(bean, name, VALUE_1)
        assertEquals(VALUE_1, p.get())
        assertEquals(VALUE_1, p.value)
        assertFalse(p.bound)
        assertEquals(bean, p.bean)
    ...
    fun testRebind() {
        attachInvalidationListeners()
        val v1: LongProperty = SimpleLongProperty(VALUE_1)
        val v2: LongProperty = SimpleLongProperty(VALUE_2)
    ...
    fun testToString() {
        ...
        this.property.set(VALUE_1)
        Assert.assertEquals("LongProperty [value: $VALUE_1]", this.property.toString())
        assertEquals("ReadOnlyLongProperty [value: $VALUE_1]", this.readOnlyProperty.toString())

        this.property.bind(v1)
        Assert.assertEquals("LongProperty [bound, invalid]", this.property.toString())
        assertEquals("ReadOnlyLongProperty [value: $VALUE_1]", this.readOnlyProperty.toString())
        this.property.get()
        Assert.assertEquals("LongProperty [bound, value: $VALUE_1]", this.property.toString())
        assertEquals("ReadOnlyLongProperty [value: $VALUE_1]", this.readOnlyProperty.toString())
        v1.set(VALUE_2)
        Assert.assertEquals("LongProperty [bound, invalid]", this.property.toString())
        assertEquals("ReadOnlyLongProperty [value: $VALUE_2]", this.readOnlyProperty.toString())
        this.property.get()
        Assert.assertEquals("LongProperty [bound, value: $VALUE_2]", this.property.toString())
        assertEquals("ReadOnlyLongProperty [value: $VALUE_2]", this.readOnlyProperty.toString())

        val bean = Any()
        val name = "My name"
        val v2 = ReadOnlyLongWrapper(bean, name, DEFAULT)
        assertEquals("LongProperty [bean: $bean, name: My name, value: $DEFAULT]", v2.toString())
        assertEquals("ReadOnlyLongProperty [bean: $bean, name: My name, value: $DEFAULT]",
                v2.readOnlyProperty.toString())

        val v3 = ReadOnlyLongWrapper(bean, "", DEFAULT)
        assertEquals("LongProperty [bean: $bean, value: $DEFAULT]", v3.toString())
        assertEquals("ReadOnlyLongProperty [bean: $bean, value: $DEFAULT]", v3.readOnlyProperty.toString())

        val v4 = ReadOnlyLongWrapper(null, name, DEFAULT)
        assertEquals("LongProperty [name: My name, value: $DEFAULT]", v4.toString())
        assertEquals("ReadOnlyLongProperty [name: My name, value: $DEFAULT]", v4.readOnlyProperty.toString())
    }

    private class ReadOnlyLongWrapperMock : ReadOnlyLongWrapper() {

...
//            assertUnchanged()
//        } else {
//            this.mao.check1AddRemove(this.array, removed, min(this.array.size, INITIAL_SIZE), this.array.size)
//        }
//        val actual = this.wrapper.toArray()
...
//                this.mao.check0()
//            } else {
//                val removed=this.wrapper.arrayOf(before.filterIndexed { index, _ ->  index>=endIndex})
//                this.mao.check1AddRemove(this.array,removed, min(this.array.size, INITIAL_SIZE),this.array.size)
//            }
//        } else {
//            if (endIndex== INITIAL_SIZE){
//                val removed=this.wrapper.arrayOf(before.filterIndexed { index, _ -> index<startIndex })
//                this.mao.check1AddRemove(this.array,removed,0,0)
//            }
//            else {
//                val removed0=this.wrapper.arrayOf(before.filterIndexed { index, _ -> index<startIndex })
//                val removed1=this.wrapper.arrayOf(before.filterIndexed { index, _ -> index>=endIndex })
//                this.mao.checkAddRemove(0, this.array, removed0, 0, 0)
//                this.mao.checkAddRemove(1,this.array,removed1,length)
//            }
//        }
//        val actual = this.wrapper.toArray()
//        assertEquals(length, this.array.size)
...
//            val removed = arrayOf(this.wrapper[i])
//

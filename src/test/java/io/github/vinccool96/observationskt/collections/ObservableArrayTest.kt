...
class ObservableArrayTest<T : ObservableArray<T>, A : Any, P>(private val wrapper: ArrayWrapper<T, A, P>) {
    ...
    private fun testSetARange(srcSize: Int, destIndex: Int, startIndex: Int, endIndex: Int) {
        val length = endIndex - startIndex
        val expected = this.wrapper.createPrimitiveArray(srcSize)

        this.wrapper.setA(expected, destIndex, startIndex, endIndex)

        this.mao.checkOnlyElementsChanged(this.array, destIndex, destIndex + length)
        val actual = this.wrapper.toArray()
        assertEquals(INITIAL_SIZE, this.array.size)
        assertEquals(INITIAL_SIZE, this.wrapper.arraySize(actual))
        this.wrapper.assertElementsEqual(actual, 0, destIndex, this.initialElements, 0)
        this.wrapper.assertElementsEqual(actual, destIndex, destIndex + length, expected, startIndex)
        this.wrapper.assertElementsEqual(actual, destIndex + length, INITIAL_SIZE, this.initialElements,
                destIndex + length)
    }
    ...
    private fun testSetPRange(srcSize: Int, destIndex: Int, startIndex: Int, endIndex: Int) {
        val length = endIndex - startIndex
        val expected = this.wrapper.createArray(srcSize)

        this.wrapper.setP(expected, destIndex, startIndex, endIndex)
    ...
    private fun testSetTRange(srcSize: Int, destIndex: Int, startIndex: Int, endIndex: Int) {
        val length = endIndex - startIndex
        val expected = this.wrapper.createPrimitiveArray(srcSize)
        val src = this.wrapper.newInstance().createNotEmptyArray(expected)

        this.wrapper.setT(src, destIndex, startIndex, endIndex)
    ...
    private fun testSetTRangeSelf(destIndex: Int, startIndex: Int, endIndex: Int) {
        val length = endIndex - startIndex
        this.wrapper.setT(this.array, destIndex, startIndex, endIndex)
        ...
        assertEquals(INITIAL_SIZE, this.wrapper.arraySize(actual))
        this.wrapper.assertElementsEqual(actual, 0, destIndex, this.initialElements, 0)
        this.wrapper.assertElementsEqual(actual, destIndex, destIndex + length, this.initialElements, startIndex)
        this.wrapper.assertElementsEqual(actual, destIndex + length, INITIAL_SIZE, this.initialElements,
                destIndex + length)
    }
    ...
    abstract class ArrayWrapper<T : ObservableArray<T>, A, P> {
        ...
        abstract fun setA(src: A, destIndex: Int, startIndex: Int, endIndex: Int)

        abstract fun setP(src: Array<P>, destIndex: Int, startIndex: Int, endIndex: Int)

        abstract fun setT(src: T, destIndex: Int, startIndex: Int, endIndex: Int)
    ...
    private class DoubleArrayWrapper : ArrayWrapper<ObservableDoubleArray, DoubleArray, Double>() {
        ...
        override fun setA(src: DoubleArray, destIndex: Int, startIndex: Int, endIndex: Int) {
            this.array.set(src, destIndex, startIndex, endIndex)
        }

        override fun setP(src: Array<Double>, destIndex: Int, startIndex: Int, endIndex: Int) {
            this.array.set(src, destIndex, startIndex, endIndex)
        }

        override fun setT(src: ObservableDoubleArray, destIndex: Int, startIndex: Int, endIndex: Int) {
            this.array.set(src, destIndex, startIndex, endIndex)
        }
    ...
    private class FloatArrayWrapper : ArrayWrapper<ObservableFloatArray, FloatArray, Float>() {
        ...
        override fun setA(src: FloatArray, destIndex: Int, startIndex: Int, endIndex: Int) {
            this.array.set(src, destIndex, startIndex, endIndex)
        }

        override fun setP(src: Array<Float>, destIndex: Int, startIndex: Int, endIndex: Int) {
            this.array.set(src, destIndex, startIndex, endIndex)
        }

        override fun setT(src: ObservableFloatArray, destIndex: Int, startIndex: Int, endIndex: Int) {
            this.array.set(src, destIndex, startIndex, endIndex)
        }
    ...
    private class IntArrayWrapper : ArrayWrapper<ObservableIntArray, IntArray, Int>() {
        ...
        override fun setA(src: IntArray, destIndex: Int, startIndex: Int, endIndex: Int) {
            this.array.set(src, destIndex, startIndex, endIndex)
        }

        override fun setP(src: Array<Int>, destIndex: Int, startIndex: Int, endIndex: Int) {
            this.array.set(src, destIndex, startIndex, endIndex)
        }

        override fun setT(src: ObservableIntArray, destIndex: Int, startIndex: Int, endIndex: Int) {
            this.array.set(src, destIndex, startIndex, endIndex)
        }
    ...
    private class LongArrayWrapper : ArrayWrapper<ObservableLongArray, LongArray, Long>() {
        ...
        override fun setA(src: LongArray, destIndex: Int, startIndex: Int, endIndex: Int) {
            this.array.set(src, destIndex, startIndex, endIndex)
        }

        override fun setP(src: Array<Long>, destIndex: Int, startIndex: Int, endIndex: Int) {
            this.array.set(src, destIndex, startIndex, endIndex)
        }

        override fun setT(src: ObservableLongArray, destIndex: Int, startIndex: Int, endIndex: Int) {
            this.array.set(src, destIndex, startIndex, endIndex)
        }

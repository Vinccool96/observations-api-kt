...
/**
 * Base class for all readonly properties wrapping a `Byte`. This class provides a default implementation to attach
 * listener.
 *
 * @see ReadOnlyByteProperty
 */
abstract class ReadOnlyBytePropertyBase : ReadOnlyByteProperty() {

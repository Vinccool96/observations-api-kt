...
/**
 * Base class for all readonly properties wrapping a `Long`. This class provides a default implementation to attach
 * listener.
 *
 * @see ReadOnlyLongProperty
 */
abstract class ReadOnlyLongPropertyBase : ReadOnlyLongProperty() {

 ...
 */
interface ObservableByteArray : ObservableArray<ObservableByteArray> {
     ...
     * @param endIndex the end (exclusive) of the subrange to copy, size of this array by default.
     */
    fun copyInto(destination: Array<Byte>, destinationOffset: Int = 0, startIndex: Int = 0, endIndex: Int = this.size)
     ...
     * @param endIndex the end (exclusive) of the subrange to copy, size of this array by default.
     */
    fun copyInto(destination: ObservableByteArray, destinationOffset: Int = 0, startIndex: Int = 0,
     ...
     */
    fun addAll(src: Array<Byte>) {
        addAll(*src.toByteArray())
    }
     ...
     */
    fun addAll(src: ObservableByteArray)
     ...
     * @param endIndex the end (exclusive) of the subrange to add
     */
    fun addAll(src: Array<Byte>, startIndex: Int, endIndex: Int) {
        addAll(src.toByteArray(), startIndex, endIndex)
    }
     ...
     * @param endIndex the end (exclusive) of the subrange to add
     */
    fun addAll(src: ObservableByteArray, startIndex: Int, endIndex: Int)
     ...
     * @param src array with elements to append
     */
    operator fun plusAssign(src: Array<Byte>) {
        addAll(*src.toByteArray())
    }
     ...
     * Utility function that uses [addAll]
     */
    operator fun plusAssign(src: ObservableByteArray) {
        addAll(src)
    }
     ...
     * @param src source observable array to copy.
     */
    fun setAll(src: ObservableByteArray)
     ...
     * @param endIndex the end (exclusive) of the subrange to copy
     */
    fun setAll(src: Array<Byte>, startIndex: Int, endIndex: Int) {
        setAll(src.toByteArray(), startIndex, endIndex)
    }
     ...
     * @param endIndex the end (exclusive) of the subrange to copy
     */
    fun setAll(src: ObservableByteArray, startIndex: Int, endIndex: Int)
     ...
     * @param endIndex the end (exclusive) of the subrange to copy
     */
    fun set(src: Array<Byte>, destinationOffset: Int, startIndex: Int, endIndex: Int) {
        set(src.toByteArray(), destinationOffset, startIndex, endIndex)
    }
     ...
     * @param endIndex the end (exclusive) of the subrange to copy
     */
    fun set(src: ObservableByteArray, destinationOffset: Int, startIndex: Int, endIndex: Int)

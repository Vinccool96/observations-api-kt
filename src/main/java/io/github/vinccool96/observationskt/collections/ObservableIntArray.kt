 ...
 */
interface ObservableIntArray : ObservableArray<Int> {

    override val baseArray: Array<Int>
        get() = arrayOf(0)
     ...
     *
     * @return a int array containing the copy of the observable array
     */
     ...
     * @param endIndex the end (exclusive) of the subrange to copy
     *
     * @return a int array containing the copy of specified portion the observable array
     */
